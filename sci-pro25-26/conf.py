...
# TODO CHANGE
jm.subtitle = "The webpage of the Scientific Programming Lab for DS""" 
jm.course = "Scientific Programming" # TODO CHANGE
jm.degree = "DS" # TODO CHANGE
author = 'Antonio Longa' # TODO CHANGE
# TODO FIRST YEAR
copyright = '# 2023 - %s, %s' % (datetime.datetime.now().year, author)
...
jm.manuals = {
    "student": {
        "name" : "DS Scientific Programming Lab",  # TODO put manual name, like "Scientific Programming"
        "audience" : "studenti",
        "args" : "",
        "output" : ""
    }
